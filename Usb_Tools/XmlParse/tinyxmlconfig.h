...
int
writeXmlFile(string rootElement,string tixmlelement,string element)
{
...
bool
ModifySingleNode_Text(const char * XmlFile,const char * strNodeName,
    const char * strText)
{
...
{
  XmlRWInterface::readXmlFile("XmlConfigTest.xml");
  //writeXmlFile();
}
#endif
